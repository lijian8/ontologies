            ...
            <div class="row">
                <div class="span3 bs-docs-sidebar">
                    <ul class="nav nav-list bs-docs-sidenav">
                        <li><a href="#herb"><i class="icon-chevron-right"></i>对中药建模</a></li>
                        <li><a href="#file-structure"><i class="icon-chevron-right"></i> File structure</a></li>
                        <li><a href="#contents"><i class="icon-chevron-right"></i> What's included</a></li>
                        <li><a href="#html-template"><i class="icon-chevron-right"></i> HTML template</a></li>
                        <li><a href="#examples"><i class="icon-chevron-right"></i> Examples</a></li>
                        <li><a href="#code"><i class="icon-chevron-right"></i>查看代码</a></li>
                    </ul>
                </div>
                <div class="span9">
                    ...
                    <section id="herb">
                        ...
                        <p class="lead">中药具有两个固有特征：（1）来源于植物，（2）作为治疗某种证候的药物。
                            一个中药的特征包括：疗效、安全性、毒性、用法等等。 
                            中药的药性主要有四气五味、升降浮沉、归经、配伍、禁忌等。 
                            中药也同样被中医理论模型中的象征符号所刻画，例如，中药具有五种药味： 酸、苦、甘、辛和咸，
                            它们分别属于木、火、土、金、水。</p>
                        <p>"中药"的OWL定义如下：</p>
  ...
  └── img/
      ...
      └── glyphicons-halflings-white.png
                    ...
                    <section id="html-template">
                        ...
                        <pre class="prettyprint linenums pre-scrollable">
                            <?php
                            //include_once("../ontologies/formula.owl");
                            $YOUR_HTML = file_get_contents ("../ontologies/formula.owl");
